...
function pageMarkup(html: string) {
  ...
  const replaceText = (value: string) => value
    .replaceAll('$40.000', '$40.000')
    .replaceAll('$120.000', '$40.000')
    .replaceAll('40.000 COP', '40.000 COP')
    ...
    .replaceAll('Páginas web desde $40.000 COP en la Sabana Occidental', 'Presencia online profesional desde $40.000 COP con SEO local en la Sabana Occidental')
    .replaceAll('Presentto crea y administra páginas web profesionales desde $40.000 COP mensuales para negocios, emprendimientos y empresas de la Sabana Occidental.', 'Presentto diseña y publica una presencia online profesional por $40.000 COP, con SEO local pensado para negocios y empresas de la Sabana Occidental.')
    .replaceAll('Páginas web profesionales desde $40.000 COP | Presentto Online', 'Presencia online profesional desde $40.000 COP | Presentto Online')
    ...
    .replaceAll('Web profesional administrada desde $40.000 COP mensuales.', 'Presencia online profesional por $40.000 COP con SEO local y estructura pensada para captar clientes en la Sabana Occidental.')
    ...
    .replaceAll('Pagas $40.000 COP mensuales y nosotros creamos, alojamos y mantenemos tu sitio según las indicaciones de tu negocio.', 'Pagas $40.000 COP por una presencia online profesional con dominio propio, contenido estratégico, diseño y SEO local para la Sabana Occidental.')
